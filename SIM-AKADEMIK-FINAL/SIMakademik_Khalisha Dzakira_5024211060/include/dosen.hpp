...
public:
	dosen(std::string id, std::string nama, int dd, int mm, int yy, std::string npp, std::string departemen, std::string pendidikan, std::string matakuliah);
	...
	void setMatakuliah(std::string matakuliah);
	std::string getMatakuliah();
};
