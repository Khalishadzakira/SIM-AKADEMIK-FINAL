...
int main()
{
	...
	while(1) {
		...
		switch (menu_terpilih) {
			...
			case 2: {
				DSN++;
                string id, nama, npp, departemen,pendidikan, matakuliah;
                int dd, mm, yy;
                id = DSN;
                cout << "Masukkan Nama Anda : ";
                cin.ignore();
                ...
                cout << "Masukkan Mata Kuliah yang diajar :";
                getline(cin, matakuliah);
                dosen inputDosen = dosen(id, nama, dd, mm, yy, npp, departemen, pendidikan, matakuliah);
			...
			case 5:{
				  for(int i = 0; i < DSN; i++){
                    ...
                    cout << "Mata Kuliah    :" << recDosen[i].getMatakuliah() << "\n";
                }
			}
				break;
			case 6:{
